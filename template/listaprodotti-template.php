<?php
// CODICE PHP PER MOSTRARE I VINI DINAMICAMENTE IN BASE AI FILTRI E ORDINAMENTI

// 1. Impostiamo i filtri di default (se non passati dal form). 
//    In un caso reale, potresti estrarli da $_POST o $_GET e/o JavaScript.
$pmin  = 0;
$pmax  = 1000;
$prov  = '%';      // Filtra la Provenienza
$friz  = '%';      // Filtra la Frizzantezza
$tona  = '%';      // Filtra la Tonalità
$dime  = '%';      // Filtra la Capacita_Bottiglia

// 2. Determiniamo la lingua per la getAllVini:
//    Immaginiamo che 1 = Italiano, 2 = Inglese, ecc.
$lingua = ($linguaAttuale === "en") ? 2 : 1;

// 3. Recuperiamo i vini tramite la funzione getAllVini(...) 
//    definita all’interno della nostra classe (es. $db).
$wines = $db->getAllVini($lingua, $pmin, $pmax, $prov, $friz, $tona, $dime);
      ...
      <div class="modal-body">
        ...
        <div class="mb-3">
          <label for="categories" class="form-label">
            <?php echo $linguaAttuale == "en" ? "Categories" : "Categorie" ?>
          </label>
        ...
        <div class="mb-3">
          <label for="formato" class="form-label">
            <?php echo $linguaAttuale == "en" ? "Bottle size" : "Formato" ?>
          </label>
    ...
    <?php foreach ($wines as $vino): ?>
      <div class="col">
        <div class="card h-100 text-center">
          <img 
            src="<?php echo "resources/img/".htmlspecialchars($vino['Foto']); ?>"
            class="card-img-top" 
          ...
          <div class="card-body">
            ...
            <p class="card-text fw-bold">
              <?php 
                // Prezzo formattato con 2 decimali e simbolo euro
