  ...
  <form class="register-form">
    ...
    <div class="mb-3">
      ...
      <div class="input-group">
        <input type="password" class="form-control" id="password" placeholder="<?php echo $linguaAttuale == "en" ? "should be at least 8 characters long" : "deve essere di almeno 8 caratteri" ?>" name="password" required />
    ...
    <div class="mb-3">
      ...
      <div class="input-group">
        <input type="password" class="form-control" id="confirm-password" placeholder="<?php echo $linguaAttuale == "en" ? "repeat password" : "tipeti password" ?>" name="confirm-password" required />
        <button class="btn btn-outline-secondary toggle-password" type="button">
          <span class="bi bi-eye" role="img" aria-label="icona occhio mostra password"></span>
        </button>
      </div>
